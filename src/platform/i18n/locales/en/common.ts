export const common = {
    ...
    // Onboarding
    onboarding_welcome_title: "Welcome to Newtab",
    onboarding_welcome_desc: "Your personalized new tab page. Let's get started with a quick setup.",
    ...
    onboarding_restore_btn: "Import Backup (.ntb)",
    onboarding_restore_skip: "Start Fresh",
