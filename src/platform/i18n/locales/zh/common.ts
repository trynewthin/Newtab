export const common = {
    ...
    search_history: "搜索历史...",
    // Onboarding
    onboarding_welcome_title: "欢迎使用 Newtab",
    onboarding_welcome_desc: "你的个性化新标签页。让我们快速完成初始设置。",
    onboarding_restore_title: "从备份恢复",
    onboarding_restore_desc: "有之前的备份文件？现在导入即可恢复所有数据。",
    onboarding_restore_btn: "导入备份 (.ntb)",
    onboarding_restore_skip: "全新开始",
    onboarding_prefs_title: "语言与外观",
    onboarding_prefs_desc: "选择界面语言和玻璃材质偏好。",
    onboarding_material_glass: "玻璃折射",
