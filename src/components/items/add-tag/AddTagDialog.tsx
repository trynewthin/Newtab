        ...
        >
            <form onSubmit={handleSubmit} className="flex flex-col gap-8 py-4">
                ...
                <div className="flex justify-center">
                    <div
                        className="w-24 h-24 flex items-center justify-center rounded-3xl border-2 border-transparent shadow-inner overflow-hidden transition-colors duration-300 ring-4 ring-background/50"
                ...
                <div className="grid gap-5">
                    <div className="grid gap-2">
                        ...
                        <Input
                            ...
                            required
                            className="h-11 border-input bg-background/50 focus:bg-background focus-visible:ring-primary/20 shadow-sm rounded-xl transition-all"
                        />
                    </div>
                    <div className="grid gap-2">
