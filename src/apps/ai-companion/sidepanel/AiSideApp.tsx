...
import "@/platform/core/i18n/i18n"; // Ensure i18n is initialized
import { BaseSidePage } from "@/platform/shared/components/sidepanel/BaseSidePage";
import { Popover, PopoverContent, PopoverTrigger } from "@/platform/shared/ui/popover";
import { History, Menu, MessageSquarePlus, Trash2, X } from "lucide-react";
import { cn } from "@/platform/core/utils";

interface AiSideAppProps {
    onClose?: () => void;
}

function AiSideApp({ onClose }: AiSideAppProps) {
